...
try:
    from ..algorithms.ppo import ActorCritic, Transition
except ImportError:
    from baselines.algorithms.ppo import ActorCritic, Transition
...
# ActorCritic and Transition are now imported from shared PPO module
